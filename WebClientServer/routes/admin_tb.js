...
{ 
    ...
    const statement =`insert into admin_tb(first_name, last_name, email,  mobile_no, password, role) values('${first_name}','${last_name}','${email}','${mobile_no}','${encryptedPassword}','${role}')`;
...
app.post("/login",(request, response)=>{
    ...
    const statement = `select * from admin_tb where email = '${email}' && password = '${encryptedPassword}'`;
